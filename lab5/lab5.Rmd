...
wss1 <- (nrow(amenity.mat)-1)*sum(apply(amenity.mat,2,var))  # total within-group sum of squares for one cluster.
for (i in 2:15) wss1[i] <- sum(kmeans(amenity.mat, centers=i)$withinss)  # try different cluster numbers
plot(1:15, wss1, type="b",    # plot and compare
